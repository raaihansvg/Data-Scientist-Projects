...
| **Amazon Sales Prediction** | End-to-end Sentiment classification of financial texts such as stock news and earnings reports using FinBERT, handling domain-specific language nuances and imbalanced datasets | [View Project](Amazon-Sales-Prediction/) |
